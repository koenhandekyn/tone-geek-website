...
set :site_url, 'http://www.tone-geek.com'
set :site_author, 'Koen Handekyn'
set :site_title, 'Tone-Geek'
set :site_description, 'Tone-Geek'
set :site_keywords, 'Guitar Effects Pedal'
